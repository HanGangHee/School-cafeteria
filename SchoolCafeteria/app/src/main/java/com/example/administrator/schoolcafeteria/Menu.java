...
public class Menu implements Serializable {
    ...
    public Menu(int menu_num,String name,int price,String ct_name,String Native,int Kcal,double total_score,int count, int image){
    ...
    public void changeData(double score_total,int person_count) {
        this.score_total = score_total;
        this.count = person_count;
    }
}
